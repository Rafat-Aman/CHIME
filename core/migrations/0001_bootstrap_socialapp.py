...
def bootstrap_socialapp(apps, schema_editor):
  Site = apps.get_model("sites", "Site")
  SocialApp = apps.get_model("socialaccount", "SocialApp")

  # Pick the primary host: use ALLOWED_HOSTS[0] if present, otherwise fallback.
...
class Migration(migrations.Migration):
  ...
  operations = [
    migrations.RunPython(bootstrap_socialapp, migrations.RunPython.noop),
  ]
